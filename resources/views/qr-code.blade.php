...
<style>
    ...
    display: flex;
    background-image: url('/Screenshot 2024-07-31 at 00-37-31 QR-Generator.png');
...
.qr{
    ...
    justify-content: center;
    text-align: center;
    border: 0px solid #180f2b;
    padding: 100px;
    border-radius: 15px;
    margin: 20px;
    box-shadow: #0b18269d 4px 4px 4px 5px;
    max-height: 300px;
    min-height:100px;
...
.mac-window-controls {
  ...
  align-items: center;
  padding: 10px;
  background-color: #efefef; /* Background color of the window bar */
  border-radius: 8px 8px 0 0; /* Rounded corners for the top of the window */
  width: fit-content;
}
...
.mac-btn.minimize:hover::after {
  content: "Code";
}

.mac-btn.maximize:hover::after {
  content: "Generator";
}
.sparkle-button {
  --active: 0;
...
<div class="qr">
    ...
    @elseif(isset($qrCode)&& request('text')!=="")
    {!! $qrCode !!}   
    @endif
